...
*Mars 2026 — Document de spécifications tri-plateforme*
*À utiliser avec Claude Code CLI + Superpowers + Callstack RN + Vercel React skills*
...
*Ce document est le contrat de specs UI. Chaque section = 1 tâche Notion. Exécuter avec Superpowers : /brainstorming → /execute-plan → /code-review.*
