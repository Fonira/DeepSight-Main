...
describe("Input Component", () => {
  ...
  describe("Custom Styles", () => {
    it("should apply custom container style", () => {
      render(
        <Input containerStyle={{ marginTop: 20 }} placeholder="Enter text" />,
      );
      expect(screen.getByPlaceholderText("Enter text")).toBeTruthy();
    });

    it("should apply custom input style", () => {
      render(<Input style={{ fontSize: 20 }} placeholder="Enter text" />);
      expect(screen.getByPlaceholderText("Enter text")).toBeTruthy();
    });
  });
  ...
  describe("Edge Cases", () => {
    ...
    it("should update when value prop changes", () => {
      const { rerender } = render(
        <Input value="Initial" placeholder="Enter text" />,
      );
      expect(screen.getByPlaceholderText("Enter text").props.value).toBe(
        "Initial",
      );
