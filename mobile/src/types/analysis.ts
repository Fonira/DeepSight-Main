...
export const WRITING_STYLE_CONFIG: Record<
  WritingStyle,
  {
...
export const VOCABULARY_CONFIG: Record<
...
> = {
  simple: {
    ...
    description: {
      fr: "Vocabulaire courant, accessible à tous",
      en: "Common vocabulary, accessible to all",
    },
  },
  moderate: {
    label: { fr: "Modéré", en: "Moderate" },
    description: {
      fr: "Équilibre entre accessibilité et précision",
      en: "Balance between accessibility and precision",
    },
  },
  advanced: {
    label: { fr: "Avancé", en: "Advanced" },
    description: {
      fr: "Terminologie spécialisée, jargon technique",
      en: "Specialized terminology, technical jargon",
    },
  },
};

// Target length configuration
export const LENGTH_CONFIG: Record<
  TargetLength,
  {
    label: { fr: string; en: string };
    description: { fr: string; en: string };
