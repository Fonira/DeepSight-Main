...
const ACKNOWLEDGEMENTS: Acknowledgement[] = [
  ...
  {
    name: "Bêta-testeurs DeepSight",
    description:
      "Pour leurs retours précieux qui façonnent le produit chaque jour",
    icon: "heart-outline",
  },
  {
...
const PartnerCard: React.FC<Partner & { colors: any }> = ({
  name,
  role,
  url,
  icon,
  ...
  >
    ...
    <View style={styles.partnerInfo}>
      ...
      <Text style={[styles.partnerRole, { color: colors.textMuted }]}>
        {role}
      </Text>
    </View>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <Text
              style={[
                styles.paragraph,
                { color: colors.textSecondary, marginTop: sp.md },
              ]}
            >
        ...
        <View style={styles.section}>
          ...
          >
            ...
            >
              ...
              <Text
                style={[styles.tableHeaderText, { color: colors.textMuted }]}
              >
                Licence
              </Text>
            </View>
            {OPEN_SOURCE_LIBS.map((lib, i) => (
              ...
              >
                ...
                <View style={styles.tableRowRight}>
                  <Text
                    style={[styles.tableCellMuted, { color: colors.textMuted }]}
                  >
                    {lib.license}
                  </Text>
                  <Ionicons
            ...
            {ACKNOWLEDGEMENTS.map((a) => (
              ...
              >
                ...
                <View style={styles.ackInfo}>
                  <Text style={[styles.ackName, { color: colors.textPrimary }]}>
                    {a.name}
                  </Text>
                  <Text style={[styles.ackDesc, { color: colors.textMuted }]}>
                    {a.description}
                  </Text>
                </View>
              </View>
          ...
          >
            <View style={styles.creatorHeader}>
              ...
              <View style={styles.creatorInfo}>
                <Text
                  style={[styles.creatorName, { color: colors.textPrimary }]}
                >
                  Maxime Le Parc
                </Text>
                <Text
                  style={[styles.creatorRole, { color: colors.accentPrimary }]}
                >
            ...
            <View style={styles.creatorDetails}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Linking.openURL("mailto:maxime@deepsightsynthesis.com")
                }
                activeOpacity={0.7}
              >
                <Ionicons
