        ...
        setResults([
          {
            ...
            status: "unverified",
            explanation:
              response.freshness?.description || "Données non disponibles",
          },
        ]);
        setShowModal(true);
        return;
          ...
          >
            {error ? (
              ...
              <>
                ...
                >
                  Cette vérification est générée par IA et peut contenir des
                  erreurs. Vérifiez toujours les informations auprès de sources
                  fiables.
                </Text>
