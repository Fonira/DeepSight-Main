...
export const VideoDiscoveryModal: React.FC<VideoDiscoveryModalProps> = ({
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const mappedVideos: DiscoveredVideo[] = (response.videos || []).map(
        (v) => ({
          video_id: v.video_id || "",
          title: v.title || "",
          channel: v.channel || "",
  ...
  const handleConfirmMultiple = () => {
    if (onSelectMultiple) {
      const selected = videos.filter((v) =>
        selectedVideos.includes(v.video_id),
      );
        ...
        >
            ...
            <TextInput
              ...
              placeholder={
                isEn
                  ...
                  : "Rechercher un sujet ou mots-clés..."
              }
          ...
          {isLoading ? (
            <View style={styles.loadingContainer}>
              ...
              >
                {isEn
                  ? "Searching quality videos..."
                  : "Recherche de vidéos de qualité..."}
              </Text>
            </View>
          ) : (
            !searchError && (
                ...
                ListEmptyComponent={
                  searchQuery.trim() ? (
                    ...
                    <View style={styles.emptyState}>
                      ...
                      >
                        {isEn
                          ? "Search for a topic to discover quality videos"
                          : "Recherchez un sujet pour découvrir des vidéos de qualité"}
                      </Text>
                    </View>
                  )
                }
          ...
          {allowMultiSelect && selectedVideos.length > 0 && (
            ...
            >
              <Text
                style={[styles.selectedCount, { color: colors.textPrimary }]}
              >
