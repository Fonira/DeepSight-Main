...
const Particle: React.FC<{
  ...
  const shapeStyle =
    shape === "rect" ? styles.particleRect : styles.particleCircle;

  return (
    <Animated.View style={[shapeStyle, { backgroundColor: color }, style]} />
  );
};

export const MicroConfetti: React.FC<MicroConfettiProps> = ({
  trigger,
  onComplete,
}) => {
  useEffect(() => {
