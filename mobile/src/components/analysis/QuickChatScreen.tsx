...
export const QuickChatScreen: React.FC<QuickChatScreenProps> = ({
  ...
  const handleUpgrade = useCallback(async () => {
    ...
    try {
      ...
      const msg =
        err?.message || err?.detail || "Erreur lors du lancement de l'analyse";
  ...
  const detectedPlatform: string = (() => {
    if (summary.platform && summary.platform !== "youtube")
    ...
    if (!isYouTubeId && vid.length > 0 && !vid.startsWith("txt_"))
      return "tiktok";
  ...
  const displayTitle =
    summary.title &&
    !["TikTok Video", "Video sans titre", "TikTok"].includes(summary.title)
      ? summary.title
      : summary.channel
  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <View
          style={[styles.platformBadge, { backgroundColor: platformBadge.bg }]}
        >
      ...
      >
        ...
        {!hasMessages && (
          <View style={styles.welcomeContainer}>
            ...
            <Text
              style={[styles.welcomeSubtitle, { color: colors.textTertiary }]}
            >
            ...
            >
              {SUGGESTED_QUESTIONS.map((q) => (
                ...
                >
                  <Text
                    style={[styles.suggestionText, { color: palette.cyan }]}
                  >
                    {q}
                  </Text>
                </Pressable>
        ...
        <View style={[styles.miniActionBar, { borderTopColor: colors.border }]}>
          ...
          >
            ...
            />
            <Text
              style={[styles.miniActionText, { color: colors.textTertiary }]}
            >
              Favori
            </Text>
          </Pressable>
