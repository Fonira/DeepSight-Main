...
> = {
  ...
  playlist: {
    ...
    descriptionFr: "L'analyse de playlists nécessite le plan Expert.",
    descriptionEn: "Playlist analysis requires the Expert plan.",
    featuresFr: getLimitFeatures("expert", "fr"),
    featuresEn: getLimitFeatures("expert", "en"),
