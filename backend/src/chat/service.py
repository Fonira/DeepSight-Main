...
- NE PAS ajouter de questions de suivi ("Voulez-vous approfondir ?", "Souhaitez-vous en savoir plus ?") sauf si explicitement demandé.
- NE PAS ajouter de listes de "pistes à explorer" ou "pour aller plus loin" à la fin — les pistes sont générées automatiquement par le système.
...
- Do NOT add follow-up questions ("Want to explore more?", "Would you like to know more?") unless explicitly asked.
- Do NOT add "to go further" or exploration lists at the end — these are auto-generated by the system.
