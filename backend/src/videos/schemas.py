...
class AnalyzeVideoV2Request(BaseModel):
    ...
    model: Optional[str] = Field(
        default=None, description="Modèle: mistral-small-2603, mistral-medium-2508, mistral-large-2512"
    )
    ...
    user_prompt: Optional[str] = Field(
        default=None, description="Instructions personnalisées de l'utilisateur", max_length=2000
    )
...
class SmartDiscoveryRequest(BaseModel):
    ...
    content_types: List[ContentTypeEnum] = Field(
        default=[ContentTypeEnum.ANY], description="Types de contenu recherchés"
    )
...
class AnalysisCustomization(BaseModel):
    ...
    # === Focus thématique ===
    focus_topics: List[str] = Field(default=[], description="Sujets sur lesquels se concentrer", max_length=10)
    exclude_topics: List[str] = Field(default=[], description="Sujets à éviter ou minimiser", max_length=10)

    # === Public cible ===
    target_audience: Optional[str] = Field(
        default=None, description="Public cible (ex: 'étudiants', 'professionnels IT', 'grand public')"
    )
    expertise_level: str = Field(
        default="intermediate", description="Niveau d'expertise attendu: beginner, intermediate, expert"
    )
...
class CommentsAnalysis(BaseModel):
    ...
    sentiment_distribution: Dict[str, int] = {"positive": 0, "negative": 0, "neutral": 0, "mixed": 0}
