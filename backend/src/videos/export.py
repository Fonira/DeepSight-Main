...
def export_to_txt(title: str, channel: str, summary: str, video_url: str, **kwargs) -> str:
...
def export_to_pdf(
    ...
    heading_style = ParagraphStyle(
        "CustomHeading", parent=styles["Heading2"], fontSize=14, spaceAfter=8, textColor=colors.HexColor("#0d6e6e")
    )
