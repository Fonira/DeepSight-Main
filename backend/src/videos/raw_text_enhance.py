...
SOURCE_PATTERNS = {
    ...
    SourceType.TRANSCRIPT: {
        ...
        "url_patterns": [r"youtube\.com", r"youtu\.be", r"vimeo\.com", r"spotify\.com", r"podcast", r"soundcloud"],
        "structure_markers": [
            "[",
    ...
    SourceType.LEGAL: {
        ...
        "url_patterns": [r"legifrance\.gouv", r"eur-lex\.europa", r"justice\.gouv", r"conseil-etat"],
        "structure_markers": ["attendu que", "considérant que", "en vertu de", "dispositions", "stipulations"],
    },
    SourceType.TECHNICAL: {
        ...
        "url_patterns": [r"github\.com", r"stackoverflow", r"docs\.", r"developer\.", r"readme", r"wiki"],
        "structure_markers": ["```", "code", "example", "output", "import", "def ", "function", "return"],
    },
    SourceType.BUSINESS: {
        "keywords": [
            "entreprise",
        ...
        "url_patterns": [r"linkedin\.com", r"\.com/investors", r"rapport-annuel", r"annual-report"],
        "structure_markers": ["Q1", "Q2", "Q3", "Q4", "YoY", "€", "$", "%", "objectifs", "KPI", "roadmap"],
    },
}
...
async def generate_smart_title(text: str, lang: str = "fr", source_context: Optional[SourceContext] = None) -> str:
    """
...
async def generate_thumbnail(
    title: str, category: str, source_type: Optional[SourceType] = None, lang: str = "fr"
) -> str:
...
async def enhance_raw_text(
    text: str, provided_title: Optional[str], category: str, lang: str = "fr", source_hint: Optional[str] = None
    ...
    thumbnail_url = await generate_thumbnail(
        title=title, category=category, source_type=source_context.source_type, lang=lang
    )
