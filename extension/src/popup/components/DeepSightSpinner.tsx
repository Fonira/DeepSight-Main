...
const PLATFORM_LOGOS: PlatformLogo[] = [
  { src: 'platforms/youtube-icon-red.png', alt: 'YouTube', size: 18, position: { top: -8, left: '50%' as unknown as number }, delay: 0 },
  { src: 'platforms/tiktok-note-white.png', alt: 'TikTok', size: 16, position: { top: '50%' as unknown as number, right: -8 }, delay: 0.5 },
  { src: 'platforms/mistral-logo-white.png', alt: 'Mistral', size: 14, position: { bottom: -8, left: '50%' as unknown as number }, delay: 1 },
  { src: 'platforms/tournesol-logo.png', alt: 'Tournesol', size: 16, position: { top: '50%' as unknown as number, left: -8 }, delay: 1.5 },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {canShowLogos && PLATFORM_LOGOS.map((logo, i) => {
