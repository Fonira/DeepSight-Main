...
const getVariantIcons = (variant: MicroVariant | string): string[] => {
  ...
  const studyIcons = [
    ...
    basePool[6],
    basePool[7],
    basePool[8], // book, lightbulb, brain, graduation
  ...
  const creativeIcons = [
    ...
    basePool[18],
    basePool[19],
    basePool[20], // star, heart, sparkle 4pt, crown, diamond
  ];
