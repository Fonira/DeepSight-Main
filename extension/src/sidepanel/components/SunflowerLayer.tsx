/**
 * SunflowerLayer v3.1 — extension sidepanel mascot.
 *
 * SVG inline avec tige + 2 feuilles + tête héliotrope (la tête pivote autour
 * de son point d'attache à la tige). 4 phases (dawn/day/dusk/night) + halo
 * bioluminescent pulsant la nuit.
 */
