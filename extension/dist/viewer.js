    ...
    (() => {
      ...
      function D(e, n, t, r, o, i, a, s, l, c, u) {
        var m,
          ...
          y = (r && r.__k) || f,
          v = n.length;
        for (l = E(t, n, y, l, v), m = 0; m < v; m++)
          null != (g = t.__k[m]) &&
            ((_ = (-1 != g.__i && y[g.__i]) || p),
            (g.__i = m),
            (A = F(e, g, _, o, i, a, s, l, c, u)),
            (d = g.__e),
            g.ref &&
              _.ref != g.ref &&
            ...
            (b = !!(4 & g.__u)) || _.__k === g.__k
              ? ((l = I(g, l, e, b)), b && _.__e && (_.__e = null))
      ...
      function R(e, n, t, r, o) {
        ...
        e: if ("style" == n)
          if ("string" == typeof t) e.style.cssText = t;
            ...
            if (t) for (n in t) (r && t[n] == r[n]) || L(e.style, n, t[n]);
          }
        else if ("o" == n[0] && "n" == n[1])
          ((i = n != (n = n.replace(m, "$1"))),
            (a = n.toLowerCase()),
      ...
      function F(e, t, r, o, i, a, s, l, c, u) {
        var m,
          _,
          g,
          d,
        ...
        e: if ("function" == typeof I)
          try {
            if (
              ((x = t.props),
              (w = I.prototype && I.prototype.render),
              (P = (m = I.contextType) && o[m.__c]),
              ...
              w &&
                ...
                y(_.__s, I.getDerivedStateFromProps(x, _.__s))),
              (d = _.props),
              (h = _.state),
              (_.__v = t),
              g)
          ...
          null == a && t.__v == r.__v
            ...
            : (l = t.__e = B(r.__e, t, r, o, i, a, s, c, u));
      ...
      function q(e, t, r) {
        ...
        if ((o = e.__k))
          for (i = 0; i < o.length; i++)
            o[i] && q(o[i], t, r || "function" != typeof e.type);
      ...
      ((e = f.slice),
        ...
        (C.prototype.setState = function (e, n) {
          ...
          ((t =
            ...
            e && y(t, e),
            null != e && this.__v && (n && this._sb.push(n), O(this)));
        }),
        ...
        (ee.__r = function (e) {
          ...
          (n &&
            (X === K
              ...
              : (n.__h.some(he), n.__h.some(pe), (n.__h = []), (Z = 0))),
            (X = K));
        }),
      ...
      (((Ne.prototype = new C()).__a = function (e) {
        var n = this,
          t = Me(n.__v),
          r = n.l.get(e);
        return (
          ...
          function (o) {
            var i = function () {
              n.props.revealOrder ? (r.push(o), Oe(n, e, r)) : o();
            };
            t ? t(i) : i();
          }
        );
          ...
          (function (e) {
            ...
            ("select" == t &&
              (r.multiple &&
                ...
                (r.value = T(n.children).forEach(function (e) {
      ...
      function ze(e) {
        ...
        for (const [e, t] of Object.entries(qe)) if (n.includes(e)) return t;
        return "📌";
      }
      function Ye(e) {
        return e
      ...
      function xn({ enabled: e = !0, children: n }) {
        ...
        return (
          ...
          je(vn.Provider, { value: { preset: t, enabled: e }, children: n })
        );
      }
      function wn() {
      ...
      const kn = "ambient_lighting_enabled",
        Cn = ({ summaryId: e }) => {
          const [n, t] = le(null),
            [r, o] = le(!0),
            [i, a] = le(null),
        ...
        Mn = parseInt(Pn.get("id") || "0", 10),
        Nn = document.getElementById("viewer-root");
      var On;
      Nn &&
        ((On = Nn),
        {
