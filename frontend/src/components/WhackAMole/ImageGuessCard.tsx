...
export const ImageGuessCard: React.FC<ImageGuessCardProps> = ({
  ...
  return (
    <motion.div
      ...
      role="dialog"
      aria-label={
        language === "fr" ? "Devinez le concept" : "Guess the concept"
      }
    >
      <div
      ...
      >
        ...
        <div
          ...
          style={{ height: REVERSE_IMAGE_SIZE }}
        >
          {/* Shimmer */}
          {!imageLoaded && (
            <div
              ...
              style={{
                background:
                  "linear-gradient(110deg, #0a0a0f 30%, #1a1a2e 50%, #0a0a0f 70%)",
          ...
          {!isRevealing && (
            <div className="absolute top-3 right-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/60 backdrop-blur-sm border border-white/10">
              ...
              <span
                className={`text-xs font-mono font-medium ${timeLeft <= 5 ? "text-red-400" : "text-white/70"}`}
              >
                {timeLeft}s
              </span>
            </div>
            ...
            <>
              ...
              <div className="flex items-center gap-2 text-text-secondary">
                ...
                <span className="text-sm font-medium">
                  {language === "fr"
                    ? "Quel concept illustre cette image ?"
                    : "What concept does this image illustrate?"}
                </span>
              </div>
