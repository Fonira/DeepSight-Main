...
const variantClasses: Record<string, string> = {
  ...
  primary:
    "bg-accent-primary-muted text-accent-primary-hover border-transparent",
  ...
  premium:
    "bg-gradient-to-r from-amber-500/15 to-orange-500/15 text-amber-400 border-amber-500/20",
};
