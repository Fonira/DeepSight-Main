      ...
      >
        <div className="relative">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(212, 165, 116, 0.4) 0%, rgba(74, 144, 217, 0.3) 40%, rgba(123, 75, 160, 0.2) 70%, transparent 85%)",
              transform: "scale(1.6)",
              filter: "blur(15px)",
            }}
          />
          ...
          {!videoError ? (
            <video
              ...
              style={{
                filter:
                  "drop-shadow(0 0 20px rgba(212, 165, 116, 0.4)) drop-shadow(0 0 15px rgba(74, 144, 217, 0.3))",
              }}
            />
          ) : (
            <img
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 30% 30%, rgba(212, 165, 116, 0.9), rgba(180, 130, 80, 0.4))",
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 30% 30%, rgba(123, 75, 160, 0.9), rgba(100, 60, 140, 0.4))",
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 30% 30%, rgba(74, 144, 217, 0.9), rgba(60, 120, 200, 0.4))",
