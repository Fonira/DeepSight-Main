...
const getDifficultyConfig = (difficulty: string) => {
  const configs: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
    debutant: { label: 'Débutant', color: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400', icon: <Star className="w-3 h-3" /> },
    ...
    intermediaire: { label: 'Intermédiaire', color: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400', icon: <><Star className="w-3 h-3" /><Star className="w-3 h-3" /></> },
    ...
    avance: { label: 'Avancé', color: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400', icon: <><Star className="w-3 h-3" /><Star className="w-3 h-3" /><Star className="w-3 h-3" /></> },
...
const getImportanceConfig = (importance: string) => {
  const configs: Record<string, { label: string; color: string }> = {
    essentiel: { label: '⭐ Essentiel', color: 'border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20' },
    essential: { label: '⭐ Essential', color: 'border-l-4 border-red-500 bg-red-50 dark:bg-red-900/20' },
    important: { label: '📌 Important', color: 'border-l-4 border-amber-500 bg-amber-50 dark:bg-amber-900/20' },
    complementaire: { label: '💡 Complémentaire', color: 'border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20' },
    complementary: { label: '💡 Complementary', color: 'border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20' },
  };
