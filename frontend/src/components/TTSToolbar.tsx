        ...
        <button
          ...
          title={
            !isPremium
              ...
              : autoPlayEnabled
                ? "Désactiver la lecture auto"
                : "Activer la lecture auto"
          }
        >
          {!isPremium ? (
          ...
          {!isPremium && (
            <span className="text-[9px] text-indigo-400 font-medium ml-0.5">
              PRO
            </span>
          )}
        </button>
        ...
        {showUpgradeHint && (
          <div className="absolute bottom-full mb-2 left-0 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
            <div className="bg-gray-900 text-white text-xs rounded-lg px-3 py-2 whitespace-nowrap border border-white/10 shadow-xl max-w-[250px]">
              La lecture vocale est disponible à partir du plan Étudiant
              (2.99€/mois)
              <a
                href="/pricing"
