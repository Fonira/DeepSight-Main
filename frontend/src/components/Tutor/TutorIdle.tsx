/**
 * 🎓 TutorIdle — Card 200×140 top-right cliquable.
 *
 * Phase `idle` du composant Tutor. Affiche le concept courant
 * (`useLoadingWord().currentWord`) + spinner cosmic. Click → openPrompting().
 *
 * Reprend le visuel du DidYouKnowCard archivé (cosmic spinner + glassmorphism)
 * en simplifiant : pas de bouton next/refresh/expand, juste un click handler.
 */
