...
const features = [
  {
    ...
    description: { fr: 'Posez vos questions a voix haute — l\'IA vous repond comme un expert', en: 'Ask your questions out loud — AI answers like an expert' },
    highlight: true,
  },
  {
    icon: (
    ...
    description: { fr: 'Revisez avec des flashcards generees automatiquement', en: 'Review with auto-generated flashcards' },
    highlight: false,
  },
  {
    icon: (
    ...
    description: { fr: 'Visualisez les idees en cartes mentales interactives', en: 'Visualize ideas as interactive mind maps' },
    highlight: false,
  },
  {
    icon: (
    ...
    description: { fr: 'Chaque affirmation verifiee par recherche web en temps reel', en: 'Every claim verified by real-time web search' },
    highlight: false,
  },
];

export default function DemoFeaturesShowcase({ language, onSignup }: DemoFeaturesShowcaseProps) {
    ...
    >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h4 className="text-white font-semibold text-sm mb-0.5">
                {lang === 'fr' ? 'Conversez litteralement avec la video' : 'Literally talk to the video'}
              </h4>
      ...
      <div className="grid grid-cols-3 gap-2">
        {features.filter(f => !f.highlight).map((feature, index) => (
          ...
          >
            <div className="text-indigo-400/70 mb-2">
              {feature.icon}
            </div>
