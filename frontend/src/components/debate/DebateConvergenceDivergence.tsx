...
export const DebateConvergenceDivergence: React.FC<DebateConvergenceDivergenceProps> = ({
  convergencePoints,
  divergencePoints,
}) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="rounded-xl bg-white/5 border border-emerald-500/20 backdrop-blur-xl p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white">Points de convergence</h3>
            <p className="text-xs text-white/40">Ce sur quoi les deux vidéos s'accordent</p>
          </div>
        </div>
      ...
      <div className="rounded-xl bg-white/5 border border-orange-500/20 backdrop-blur-xl p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            <h3 className="text-sm font-semibold text-white">Points de divergence</h3>
            <p className="text-xs text-white/40">Là où les positions s'opposent</p>
          </div>
        </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div className="rounded-md bg-indigo-500/[0.06] border border-indigo-500/15 p-2">
                  <span className="text-[10px] font-semibold text-indigo-400 uppercase">Vidéo A</span>
                  <p className="text-xs text-white/70 mt-1 leading-relaxed">{point.position_a}</p>
                </div>
                <div className="rounded-md bg-violet-500/[0.06] border border-violet-500/15 p-2">
                  <span className="text-[10px] font-semibold text-violet-400 uppercase">Vidéo B</span>
                  <p className="text-xs text-white/70 mt-1 leading-relaxed">{point.position_b}</p>
                </div>
              </div>
