      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-8 relative z-10">
        ...
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="text-text-primary space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 ml-4">
              ...
              <li>
                Choisir la formule d'abonnement souhaitee depuis la page de
                tarification ou les parametres du compte
              </li>
              <li>
                Etre redirige vers la plateforme de paiement securisee Stripe
                pour completer le paiement
              </li>
              <li>Confirmer le paiement par carte bancaire</li>
            </ol>
            <p>
              <strong>3.2 -- Confirmation.</strong> Apres validation du
              paiement, l'Utilisateur recoit un email de confirmation de
              souscription a l'adresse associee a son compte. L'abonnement prend
              effet immediatement apres la validation du paiement.
            </p>
            <p>
              <strong>3.3 -- Acces immediat.</strong> Les fonctionnalites de
              l'abonnement souscrit sont accessibles immediatement apres la
        ...
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="text-text-primary space-y-3">
            <p>
              ...
              Express et autres cartes acceptees par Stripe) via la plateforme
            ...
            <p>
              <strong>4.4 -- Facturation.</strong> {LEGAL_INFO.vat.status}. Un
              recu de paiement est disponible apres chaque transaction via le
              portail de gestion Stripe accessible depuis les parametres du
              compte.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="text-text-primary space-y-3">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                Renonce expressement a son droit de retractation de 14 jours
                prevu a l'article L221-18 du Code de la consommation
              </li>
            </ul>
            <p>
        ...
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="text-text-primary space-y-3">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Depuis les parametres de son compte sur le Service (rubrique
                "Mon abonnement")
              </li>
              <li>Via le portail de gestion Stripe</li>
              <li>
                En contactant le support a l'adresse{" "}
                <a
        ...
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="text-text-primary space-y-3">
            ...
            <p>
              ...
              ou la resolution du contrat dans les conditions prevues par la
              loi.
            </p>
            <p>
        ...
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="text-text-primary space-y-3">
            ...
            <p>
              <strong>10.3 -- Mediation.</strong> Conformement aux articles
