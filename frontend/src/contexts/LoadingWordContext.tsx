...
export const LoadingWordProvider: React.FC<{ children: ReactNode }> = ({
   ...
   */
  const pickLocalFallback = useCallback(() => {
   ...
   */
  const pickHistoryWord = useCallback(() => {
  ...
  }, [fetchHistoryKeywords, pickHistoryWord, pickLocalFallback]);
  ...
  }, [pickHistoryWord, pickLocalFallback]);
