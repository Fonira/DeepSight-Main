...
// ═══════════════════════════════════════════════════════════════════════════════
// 💳 PLANS & LIMITES
// ⚠️ Le SSOT frontend des plans est `config/planPrivileges.ts` (Pricing v2 :
// Free / Pro 8,99 € / Expert 19,99 €). Le bloc PLAN_CONFIGS/PlanType/getPlanConfig
// historique de ce fichier a ete retire (dead code, plus aucun import) afin
// d'eviter toute reintroduction de prix v0/v1 obsoletes. Pour acceder aux plans :
//   import { PLANS_INFO, PLAN_LIMITS, normalizePlanId } from "../config/planPrivileges";
// ═══════════════════════════════════════════════════════════════════════════════
